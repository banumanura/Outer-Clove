...
<body>
    ...
    <section class="navbar">
        ...
        <img style="width: 300px;height:90px;padding:1rem" src="images/the-outer-clove-restaurant-high-resolution-logo-transparent.png" alt="">
            </div>
            ...
            <div class="menu ">
                <ul class="links">
                    ...
                    <li>
                        <a href="<?php echo URL; ?>category.php">Categories</a>
                    </li>
                    <li>
                        <a href="<?php echo URL; ?>foods.php">Foods</a>
                    </li>
                    <li>
                        <a href="<?php echo URL; ?>reservation.php">Reservation</a>
                    </li>
                    <li>
                        <a href="#">Contact</a>
                    </li>
